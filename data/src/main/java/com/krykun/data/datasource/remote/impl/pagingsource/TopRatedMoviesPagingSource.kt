...
LoadResult.Page object with the data, the previous key (which is null in this case), and the next
key (which is the next page number). If we get an error, we return a LoadResult.Error object with
the error */
